...
@interface YSCWebImageFrame : NSObject

// This class is used for creating animated images via `animatedImageWithFrames` in `YSCWebImageCoderHelper`. Attension if you need animated images loop count, use `YSC_imageLoopCount` property in `UIImage+MultiFormat`
