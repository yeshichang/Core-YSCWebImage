...
/**
 * Integrates YSCWebImage async downloading and caching of remote images with UIImageView.
 *
 * Usage with a UITableViewCell sub-class:
 *
 * @code

#import <YSCWebImage/UIImageView+WebCache.h>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided YSC_setImageWithURL: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView YSC_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
 ...
 */
- (void)YSC_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 * @see YSC_setImageWithURL:placeholderImage:options:
 */
...
- (void)YSC_setImageWithURL:(nullable NSURL *)url
          placeholderImage:(nullable UIImage *)placeholder
                   options:(YSCWebImageOptions)options NS_REFINED_FOR_SWIFT;
...
- (void)YSC_setImageWithURL:(nullable NSURL *)url
          placeholderImage:(nullable UIImage *)placeholder
                 completed:(nullable YSCExternalCompletionBlock)completedBlock NS_REFINED_FOR_SWIFT;
