//
//  DRAgentAnimatedImageView+YSCWebCache.h
//  DRAgentYSCK
//
//  Created by mac on 2018/2/28.
//  Copyright © 2018年 DRAgentYSCK. All rights reserved.
//
...
@interface UIImage (DRAgentAnimatedImage)

@property (nonatomic, strong, nullable) DRAgentAnimatedImage *YSC_DRAgentAnimatedImage;

@end

@interface DRAgentAnimatedImageView (YSCWebCache)
