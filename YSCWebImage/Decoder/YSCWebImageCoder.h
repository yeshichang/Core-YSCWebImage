 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const YSCWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull YSCCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL YSCCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {YSCWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
...
/**
 ...
 @param format The image format to encode, you should note `YSCImageFormatUndefined` format is also  possible
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(YSCImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol YSCWebImageProgressiveCoder <YSCWebImageCoder>
