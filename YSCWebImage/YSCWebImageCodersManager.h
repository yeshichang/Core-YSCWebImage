...
/**
 ...
 Coders
 ------
 A coder must conform to the `YSCWebImageCoder` protocol or even to `YSCWebImageProgressiveCoder` if it supports progressive decoding
 ...
 */
@property (nonatomic, strong, readwrite, nullable) NSArray<YSCWebImageCoder>* coders;
